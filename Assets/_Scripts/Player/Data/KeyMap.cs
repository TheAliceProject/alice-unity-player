...
public static class KeyMap
{
    ...
    public static readonly List<Key> UpKeys = new List<Key> {Key.UP, Key.W, Key.RIGHT_AXIS_UP};
    public static readonly List<Key> DownKeys = new List<Key> {Key.DOWN, Key.S, Key.RIGHT_AXIS_DOWN};
    public static readonly List<Key> LeftKeys = new List<Key> {Key.LEFT, Key.A, Key.RIGHT_AXIS_LEFT};
    public static readonly List<Key> RightKeys = new List<Key> {Key.RIGHT, Key.D, Key.RIGHT_AXIS_RIGHT};
    public static readonly List<Key> SecondaryUpKeys = new List<Key> {Key.I, Key.LEFT_AXIS_UP};
    public static readonly List<Key> SecondaryDownKeys = new List<Key> {Key.K, Key.LEFT_AXIS_DOWN};
    public static readonly List<Key> SecondaryLeftKeys = new List<Key> {Key.J, Key.LEFT_AXIS_LEFT};
    public static readonly List<Key> SecondaryRightKeys = new List<Key> {Key.L, Key.LEFT_AXIS_RIGHT};
    ...
    public static readonly List<Key> SecondaryArrowKeys = new List<Key> {Key.LEFT, Key.RIGHT, Key.UP, Key.DOWN,
