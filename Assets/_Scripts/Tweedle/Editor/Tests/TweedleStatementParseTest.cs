...
namespace Alice.Tweedle.Parse
{
    ...
    public class TweedleStatementParseTest
    {
        ...
        public void AConditionalCreatedForIfThenShouldHaveCondition()
        {
            ...
            Assert.AreEqual(TValue.TRUE, tested.Condition, "The parser should have returned a TweedleConditionalStatement with a true condition.");
        }
        ...
        {
            WhileLoop tested = (WhileLoop)ParseStatement("while(true) { }");
            Assert.AreEqual(TValue.TRUE, tested.RunCondition, "The TweedleWhileLoop run condition should be the value True.");
        }
        ...
        public void AnEmptyReturnShouldBeCreatedForEmptyReturn()
        {
            ...
            Assert.AreEqual(TValue.UNDEFINED, tested.Expression, "The TweedleReturnStatement should hold an undefined value.");
        }
        ...
        {
            ReturnStatement tested = (ReturnStatement)ParseStatement("return;");
            Assert.AreEqual(TValue.UNDEFINED, tested.Expression, "The TweedleReturnStatement should be type void.");
        }
        ...
        {
            ITweedleExpression tested = ((LocalVariableDeclaration)ParseStatement("WholeNumber a <- 2;"))
                .Variable.Initializer;
            Assert.IsInstanceOf<TWholeNumberType>(tested.Type.Get(), "The TweedleLocalVariableDeclaration should hold a integer primitive value.");
        }

        [Test]
        public void AVariableDeclarationShouldHaveAnInitializerOfTwo()
        {
            TValue tested = (TValue)((LocalVariableDeclaration)ParseStatement("WholeNumber a <- 2;"))
                .Variable.Initializer;
            Assert.AreEqual(2, tested.ToInt(), "The TweedleLocalVariableDeclaration should hold 2.");
        }
