...
namespace Alice.Tweedle.Parsed
{
	...
	public class TweedleStatementRunTest
	{
		void ExecuteStatement(string src, ExecutionScope scope)
		{
			...
			scope.vm.ExecuteToFinish(stmt, scope);
		}
		...
		{
			return new ExecutionScope("Test", new VirtualMachine(new TweedleSystem()));
		}
		...
		public void LocalDeclarationShouldUpdateTheScope()
		{
			...
			Assert.NotNull(scope.GetValue("x"));
		}
		...
		public void LocalDeclarationShouldSetTheValueOnTheScope()
		{
			...
			Assert.AreEqual(3, ((TweedlePrimitiveValue<int>)scope.GetValue("x")).Value, "Should be 3");
		}
		...
		public void DoInOrderSingletonShouldUpdateParentValues()
		{
			...
			Assert.AreEqual(4, ((TweedlePrimitiveValue<int>)scope.GetValue("x")).Value, "Should be 4");
		}
		...
		public void DoInOrderSequenceShouldUpdateParentValues()
		{
			...
			Assert.AreEqual(12, ((TweedlePrimitiveValue<int>)scope.GetValue("x")).Value, "Should be 12");
		}
		...
		public void DoInOrderSequenceShouldReadPreviousValues()
		{
			...
			Assert.AreEqual(14, ((TweedlePrimitiveValue<int>)scope.GetValue("x")).Value, "Should be 14");
		}
		...
		public void DoTogetherSequenceShouldUpdateParentValuesInSomeOrder()
		{
			...
			Assert.AreNotEqual(3, ((TweedlePrimitiveValue<int>)scope.GetValue("x")).Value, "Should no longer be 3");
		}
		...
		public void ConditionalTrueShouldEvaluateThen()
		{
			...
			Assert.AreEqual(5, ((TweedlePrimitiveValue<int>)scope.GetValue("x")).Value, "Should be 5");
		}
		...
		public void ConditionalFalseShouldEvaluateElse()
		{
			...
			Assert.AreEqual(17, ((TweedlePrimitiveValue<int>)scope.GetValue("x")).Value, "Should be 17");
		}
		...
		public void CountLoopShouldEvaluateNTimes()
		{
			...
			Assert.AreEqual(3, ((TweedlePrimitiveValue<int>)scope.GetValue("x")).Value, "Should be 6");
		}
		...
		public void NestedCountLoopsShouldEvaluateNxNTimes()
		{
			...
			Assert.AreEqual(9, ((TweedlePrimitiveValue<int>)scope.GetValue("x")).Value);
		}
		...
		public void NestedCountLoopsShouldEvaluate64Times()
		{
			...
			Assert.AreEqual(64, ((TweedlePrimitiveValue<int>)scope.GetValue("x")).Value);
		}
		...
		public void NestedCountLoopsShouldEvaluateNxNxNTimes()
		{
			...
			Assert.AreEqual(1000, ((TweedlePrimitiveValue<int>)scope.GetValue("x")).Value);
		}
		...
		public void ForEachLoopShouldEvaluateNTimes()
		{
			...
			Assert.AreEqual(10, ((TweedlePrimitiveValue<int>)scope.GetValue("x")).Value, "Should be 10");
		}
		...
		public void AWhileLoopShouldReevaluateEachLoop()
		{
			...
			Assert.AreEqual(4, ((TweedlePrimitiveValue<int>)scope.GetValue("x")).Value);
		}
		...
		public void EachTogetherShouldChangeParentValues()
		{
			...
			Assert.AreNotEqual(0, ((TweedlePrimitiveValue<int>)scope.GetValue("x")).Value);
		}
