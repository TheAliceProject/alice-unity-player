...
namespace Alice.Tweedle.Parsed
{
    public class TweedleStatementParseTest
    {
        ...
        {
            DoInOrder tested = (DoInOrder)ParseStatement("doInOrder { doInOrder {} return; }");
            Assert.IsInstanceOf<DoInOrder>(tested.Statements[0], "The block's first statement should be a TweedleDoInOrder.");
        }
        ...
        {
            DoInOrder tested = (DoInOrder)ParseStatement("doInOrder { doInOrder {} return; }");
            Assert.IsInstanceOf<ReturnStatement>(tested.Statements[1], "The block's first statement should be a Return.");
        }
        ...
        {
            DoTogether tested = (DoTogether)ParseStatement("doTogether { doInOrder {} return; }");
            Assert.IsInstanceOf<DoInOrder>(tested.Statements[0], "The block's first statement should be a DoInorder.");
        }
