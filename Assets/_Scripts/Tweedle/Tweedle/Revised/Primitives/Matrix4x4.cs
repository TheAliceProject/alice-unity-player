...
// Source: https://referencesource.microsoft.com/#System.Numerics/System/Numerics/Matrix4x4.cs
...
namespace Alice.Tweedle.Primatives
{
    ...
    public struct Matrix4x4 : IEquatable<Matrix4x4>
    {
		...
		*/
        ...
        {
            const double epsilon = 1e-4f;
            const double minAngle = 1.0f - (0.1f * ((double)Math.PI / 180.0f)); // 0.1 degrees
            ...
            {
                faceDir = Vector3.Multiply(faceDir, (1.0f / (double)Math.Sqrt(norm)));
            }
        ...
        public static Matrix4x4 CreatePerspectiveFieldOfView(double fieldOfView, double aspectRatio, double nearPlaneDistance, double farPlaneDistance)
        {
            ...
            double yScale = 1.0f / (double)Math.Tan(fieldOfView * 0.5f);
