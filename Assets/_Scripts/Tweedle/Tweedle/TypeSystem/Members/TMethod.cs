...
namespace Alice.Tweedle
{
    ...
    public abstract class TMethod : ITypeMember
    {
        ...
        public virtual void Link(TAssembly inAssembly, TType inOwnerType)
        {
            ContainingType = inOwnerType;
            Type.Resolve(inAssembly);
            ...
            {
                RequiredParams[i].Type.Resolve(inAssembly);
            ...
            {
                OptionalParams[i].Type.Resolve(inAssembly);
