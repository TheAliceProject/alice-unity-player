...
public interface ITweedleParserListener : IParseTreeListener {
	...
	void EnterCompilationUnit([NotNull] TweedleParser.CompilationUnitContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="TweedleParser.compilationUnit"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitCompilationUnit([NotNull] TweedleParser.CompilationUnitContext context);
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterFormalParameter([NotNull] TweedleParser.FormalParameterContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="TweedleParser.formalParameter"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitFormalParameter([NotNull] TweedleParser.FormalParameterContext context);
	/// <summary>
