...
#endif
                    EditorGUILayout.PropertyField(_tempSerializedObject.FindProperty("UseOriginalPositionRotationAndScale"));
                    break;
                case 1:
                    {
                ...
                case 2:
                    {
                        ...
                        {
                            EditorGUILayout.PropertyField(_tempSerializedObject.FindProperty("LoadRawMaterialProperties"));
                            ...
                            EditorGUILayout.PropertyField(_tempSerializedObject.FindProperty("MaterialShadingMode"));
                            if (!disableAlphaMaterials.boolValue)
                            {
                                EditorGUILayout.PropertyField(_tempSerializedObject.FindProperty("ScanForAlphaMaterials"));
                                EditorGUILayout.PropertyField(_tempSerializedObject.FindProperty("MaterialTransparencyMode"));
                            }
                ...
                case 3:
                    {
                        ...
                        {
                            EditorGUILayout.PropertyField(_tempSerializedObject.FindProperty("ForceAnimationComponents"));
                ...
                case 5:
                    {
                        ...
                        var loadMetadataProperty = _tempSerializedObject.FindProperty("DontLoadMetadata");
                        EditorGUILayout.PropertyField(loadMetadataProperty);
                        if (!loadMetadataProperty.boolValue)
                        {
                            EditorGUILayout.PropertyField(_tempSerializedObject.FindProperty("DontAddMetadataCollection"));
                        }
                    }
                    break;
                default:
